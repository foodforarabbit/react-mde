...
var ReactMde = /** @class */ (function (_super) {
        ...
        _this.handleGripMouseMove = function (event) {
            if (_this.gripDrag !== null) {
                ...
                if (newHeight >= _this.props.minEditorHeight && newHeight <= _this.props.maxEditorHeight) {
                    _this.setState(__assign(__assign({}, _this.state), { editorHeight: _this.gripDrag.originalHeight + (event.clientY - _this.gripDrag.originalDragY) }));
                }
            }
        };
    ...
    ReactMde.prototype.render = function () {
        var _this = this;
        var _a = this.props, getIcon = _a.getIcon, commands = _a.commands, className = _a.className, loadingPreview = _a.loadingPreview, emptyPreviewHtml = _a.emptyPreviewHtml, readOnly = _a.readOnly, value = _a.value, l18n = _a.l18n, minPreviewHeight = _a.minPreviewHeight, textAreaProps = _a.textAreaProps, selectedTab = _a.selectedTab, generateMarkdownPreview = _a.generateMarkdownPreview;
        return (React.createElement("div", { className: ClassNames_1.classNames("react-mde", "react-mde-tabbed-layout", className) },
            ...
            selectedTab === "write" ?
                ...
                :
                    React.createElement(_1.MdePreview, { previewRef: function (c) { return _this.previewRef = c; }, loadingPreview: loadingPreview || emptyPreviewHtml, minHeight: minPreviewHeight, generateMarkdownPreview: generateMarkdownPreview, markdown: value })));
    };
