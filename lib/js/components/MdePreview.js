...
var MdePreview = /** @class */ (function (_super) {
    ...
    MdePreview.prototype.render = function () {
        ...
        return (React.createElement("div", { className: ClassNames_1.classNames("mde-preview", { className: className, loading: loading }), style: { minHeight: minHeight + 10 }, "data-testid": "mde-preview" }, content));
    };
    return MdePreview;
}(React.Component));
